...
alias unrshift="xmodmap -e 'remove shift = Shift_R' && xmodmap -e 'keycode 62 = Escape NoSymbol'"
...
alias names="git diff --name-only | cat"
alias staged="git diff --name-only --staged | cat"
alias gp="git pull"
alias log="git log"
alias pull="git pull"
alias push="git push"
...
alias :qw="sl && cowsay hi i am vim && sleep 2 && exit"
alias :q=":wq"
alias :q!=":wq"
alias quit="cowsay hi i am gdb && sleep 2"
