...
-- REMOVING FOR NOW, USE + AND * REGISTERS INSTEAD
...
-- This is used for Cursorhold action later
...
vim.o.cursorline = true -- to be deleted as soon as mini.cursorword is added
...
--  See `:help hlsearch`
--  You can push escape in normal mode to get rid of all the highlights leftover from a search
vim.keymap.set("n", "<Esc>", "<cmd>nohlsearch<CR>")

-- Diagnostic keymaps
vim.keymap.set("n", "<leader>q", vim.diagnostic.setloclist, { desc = "Open diagnostic [Q]uickfix list" })

-- CHOPPING BLOCK - DOESNT WORK FOR KITTY AS OF RIGHT NOW
...
-- By default these conflict with some kitty mappings.  I have changed them in kitty
-- becuase I find these mappings to be much more convenient
...
require("lazy").setup({
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-------CHOPPING BLOCK---------
					-- These shortcuts do not seem to be showing up
	...
	{ -- Autocompletion
		...
		opts = {
			...
			completion = {
				...
				-- Optionally, set `auto_show = true` to show the documentcation after a delay.
	...
	-- Opens files to location previously edited
	-- This plugin is AI slop, and in the
